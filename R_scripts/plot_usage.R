...
cpu.qiime1.1 = (160.27/60)/60
cpu.qiime1.2 = (87.86/60)/60
cpu.qiime1.3 = (93.75/60)/60
...
mem.qiime1.1 = (16462)/1024
mem.qiime1.2 = (18761)/1024
mem.qiime1.3 = (15171)/1024
...
# plot bargraph w/ mem usage
print(ggplot(mem.df, aes(x=variable, y=value))
      + geom_bar(stat="identity", fill="darkgray", alpha=0.8)
